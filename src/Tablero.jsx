          ...
          <div className="grid-container">
            ...
            <div className="ships-overlay">
              {ships.map(ship => {
                ...
                const cellSize = 30;
                const boardStartX = 30; // Ajuste para las etiquetas de fila
                const boardStartY = 30; // Ajuste para las etiquetas de columna
                
                const pixelX = boardStartX + ship.col * cellSize;
                const pixelY = boardStartY + ship.row * cellSize;
                
                const width = ship.orientation === 'horizontal' ? ship.size * cellSize : cellSize;
                const height = ship.orientation === 'horizontal' ? cellSize : ship.size * cellSize;
